...
savant$pfx_x <- as.integer(savant$pfx_x)
savant$pfx_z <- as.integer(savant$pfx_z)
savant$plate_x <- as.integer(savant$plate_x)
savant$plate_z <- as.numeric(savant$plate_z)
